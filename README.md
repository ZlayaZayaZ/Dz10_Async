[![Build status](https://ci.appveyor.com/api/projects/status/pq5v32mr7s2148jo?svg=true)](https://ci.appveyor.com/project/ZlayaZayaZ/dz10-async)

# Домашнее задание к лекции «Promises, async/await»[Исходник](https://github.com/netology-code/ajs-homeworks/blob/master/async/README.md)
